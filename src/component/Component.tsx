...
// XML의 형태와 유사하고 DOM트리르 생성하는 JS, TS 확장자
...
// - render() 메서드의 반환값으로 렌더링 하고자하는 요소를 반환
...
//Vscode의 ES7+ / React/Redux/React-Native snippets 확장 설치
//단축 명령으로 컴포넌트 생성
...
//1. 반드시 하나의 요소를 반환
//2. 모든 태그를 닫아줘야함
//3 . 속성들은 JSX로 지정된 이름을 사용해야함 (lowerCamelCase)
//4. 주석을 사용할 땐 {/* */}를 사용
